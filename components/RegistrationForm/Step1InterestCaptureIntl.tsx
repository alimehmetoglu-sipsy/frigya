...
export default function Step1InterestCaptureIntl({ data, errors, onUpdate, onNext }: Step1Props) {
  ...
  const routeOptions: RouteOption[] = locale === 'tr' ? [
    {
      id: 'full_trail',
    ...
    {
      id: 'full_trail',
      name: 'Full Trail (14 Days)',
      description: 'Complete Phrygian Way experience from Eskişehir to Afyon',
      image: '/images/routes/full-trail.svg',
      duration: '14 days',
    ...
    {
      id: 'eastern',
      name: 'Eastern Route (7 Days)',
      description: 'Historic region between Eskişehir and Gordion',
      image: '/images/routes/eastern.svg',
      duration: '7 days',
      difficulty: 'Moderate'
    },
    {
      id: 'southern',
      name: 'Southern Route (5 Days)',
      description: 'Ancient cities around Afyon',
      image: '/images/routes/southern.svg',
      duration: '5 days',
      difficulty: 'Easy'
    },
    {
      id: 'western',
      name: 'Western Route (4 Days)',
      description: 'Nature walk between Kütahya and Tavşanlı',
      image: '/images/routes/western.svg',
      duration: '4 days',
      difficulty: 'Easy'
    },
    {
      id: 'undecided',
      name: 'Undecided',
      description: 'Let\'s determine the suitable route together',
      image: '/images/routes/undecided.svg',
      duration: 'Variable',
      difficulty: 'Variable'
    }
  ...
  const timeframeOptions = locale === 'tr' ? [
    ...
    { id: 'next_month', label: 'Next Month', description: 'I want to start immediately' },
    { id: 'next_3_months', label: 'Next 3 Months', description: 'Planning for near future' },
    { id: 'next_6_months', label: 'Next 6 Months', description: 'Within this year' },
    { id: 'next_year', label: 'Next Year', description: 'Planning for next year' },
    { id: 'just_exploring', label: 'Just Exploring', description: 'No specific date yet' }
  ];

  const groupTypeOptions = locale === 'tr' ? [
    ...
    { id: 'solo', label: 'Solo', icon: '👤', description: 'Individual hiking experience' },
    { id: 'couple', label: 'Couple', icon: '👫', description: 'Romantic journey for 2' },
    { id: 'friends', label: 'Friend Group', icon: '👥', description: '3-8 person friend group' },
    { id: 'family', label: 'Family', icon: '👨‍👩‍👧‍👦', description: 'Family adventure' },
    { id: 'organized_group', label: 'Organized Group', icon: '🚌', description: '10+ person organized tour' }
  ];
    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
          {locale === 'tr' ? 'Frigya Yolu Yolculuğunuza Başlayalım' : 'Start Your Phrygian Way Journey'}
        </h2>
        <p className="text-gray-600">
          {locale === 'tr' ? 'Size en uygun deneyimi oluşturmak için birkaç soru soracağız' : 'We\'ll ask a few questions to create the best experience for you'}
        </p>
        <div className="mt-4 w-full bg-gray-200 rounded-full h-2">
          <div className="bg-blue-600 h-2 rounded-full w-1/4"></div>
        </div>
        <p className="text-sm text-gray-500 mt-2">{locale === 'tr' ? 'Adım' : 'Step'} 1 / 4</p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          <h3 className="text-xl font-semibold text-gray-800">
            {locale === 'tr' ? 'Hangi rotayla ilgileniyorsunuz?' : 'Which route are you interested in?'}
          </h3>
          <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">
            {locale === 'tr' ? 'Neden soruyoruz?' : 'Why we ask?'}
          </span>
        </div>
            ...
            >
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className={`px-2 py-1 rounded-full text-xs ${
                  route.difficulty === 'Kolay' || route.difficulty === 'Easy' ? 'bg-green-100 text-green-800' :
                  route.difficulty === 'Orta' || route.difficulty === 'Moderate' ? 'bg-yellow-100 text-yellow-800' :
                  route.difficulty === 'Zor' || route.difficulty === 'Challenging' ? 'bg-red-100 text-red-800' :
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-800">
          {locale === 'tr' ? 'Ne zaman yürüyüş yapmayı planlıyorsunuz?' : 'When are you planning to hike?'}
        </h3>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-gray-800">
          {locale === 'tr' ? 'Kimlerle yürüyüş yapacaksınız?' : 'Who will you be hiking with?'}
        </h3>
      ...
      <div className="bg-gray-50 rounded-lg p-4 text-center">
        <p className="text-sm text-gray-600">
          <span className="font-semibold text-blue-600">2,847</span> {locale === 'tr' ? 'yürüyüşçü bu adımdan başladı' : 'hikers started from this step'}
        </p>
      </div>
    </div>
  );
