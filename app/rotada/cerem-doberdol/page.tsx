      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-primary-50 to-white">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Arnavutluk'un yüksek dağlık bölgelerine doğru çıkış yapacağınız zorlu ama ödüllendirici etap.
          </p>

          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <p className="text-blue-900">
              Bu etapın detaylı bilgileri yakında eklenecektir. 
              Çerem'den Dobërdol'a doğru uzanan bu rota, yüksek dağ geçitleri ve 
              muhteşem panoramik manzaralar sunar.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-12">
            ...
            >
              Önceki Etap: Valbonë - Çerem
            </Link>
            <Link
              href="/rotada/doberdol-milishevc"
              className="btn-primary text-center"
            >
              Sonraki Etap: Dobërdol - Milishevc
            </Link>
          </div>
        </div>
      </section>
